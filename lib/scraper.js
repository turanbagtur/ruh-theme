...
// ═══════════════════════════════════════════════════════════════════════════════
// Comix.to  (Next.js SSR — chapter list lives in __NEXT_DATA__)
// ═══════════════════════════════════════════════════════════════════════════════
async function scrapeComixTo(seriesUrl) {
    ...
    // Comix.to is a Next.js app — chapter list is embedded in __NEXT_DATA__
    const chapters = extractComixToChapters($, seriesUrl)
