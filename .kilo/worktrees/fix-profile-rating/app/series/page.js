...
// Initial load after mount + refetch when filters change
  ...
  return (
    <div className="page-container page-section fade-in glass-page-container">
      {/* Header */}
      <div className="glass-page-header" style={{ marginBottom: 20 }}>
      ...
      {/* Filter Bar */}
      <div className="filter-bar glass-filter-bar" style={{ marginBottom: 12 }}>
      ...
      {/* Genre Tags */}
      <div className="glass-genre-tags-wrapper" style={{ marginBottom: 12 }}>
      ...
      {loading ? (
        ...
        <div className="series-list-view">
          {series.map(s => {
            ...
            if (isBlurred) {
              return (
                <div key={s.id} className="series-list-item" style={{ cursor: 'pointer', position: 'relative' }}
                  ...
                  <div className="series-list-info">
                    ...
                    <div className="series-list-meta">
                      ...
                      <span className="genre-tag" style={{ background: 'rgba(239,68,68,0.15)', color: '#ef4444', border: '1px solid rgba(239,68,68,0.3)', padding: '2px 8px', fontSize: '0.68rem' }}>
                        🔞 Yetişkin
                      </span>
                    </div>
