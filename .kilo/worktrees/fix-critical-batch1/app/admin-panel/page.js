                                    ...
                                    {(() => {
                                        ...
                                        <tr key={u.id}>
                                            ...
                                            <td><span className={`admin-badge ${u.role !== 'user' ? 'admin-role' : 'user-role'}`}>{
                                                {admin: 'Kurucu', manager: 'Yönetici', moderator: 'Moderatör', team_member: 'Yükleyici', user: 'Kullanıcı'}[u.role] ||
                                                customRoles.find(r => r.name === u.role)?.label || u.role || 'Kullanıcı'
                                            }</span></td>
                                                ...
                                                <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap', alignItems: 'center' }}>
                                                    {(user.role === 'admin' || (user.role === 'manager' && u.role !== 'admin')) ? (
                                                        ...
                                                        >
                                                            ...
                                                            {customRoles.length > 0 && <option disabled>── Özel Roller ──</option>}
                                                            {customRoles.map(r => (
